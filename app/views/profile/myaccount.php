...
<div class="row">
    ...
    <div class="col" style="background-color: #F5F5FB;">
        ...
        <div class="row" style="margin-bottom: 1rem;margin-left: 1rem;">
            <p style="color:#9191A9; font: size 19px;">Supplier's detailed information</p>
        </div>
            ...
            <form action="<?= base_url ?>dashboard/updateAccount" method="POST">
                <div class="row">
                    <div class="col mb-3" style="margin-top: 1rem;">
                        ...
                        <input type="text" class="form-control my-input" id="exampleInputEmail1" aria-describedby="emailHelp" name="name" value="<?= $data['user']['name'] ?>" readonly>
                    </div>
                    <div class="col mb-3" style="margin-top:1rem;" >
                        <label for="exampleInputEmail1" class="form-label">Email</label>
                        <input type="text" class="form-control my-input" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<?= $data['user']['email'] ?>" readonly>
                    </div>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Address</label>
                    <input type="text" class="form-control my-input" id="exampleInputPassword1" name="address" value="<?= $data['user']['address'] ?>" readonly>
                </div>
                <div class="row">
                <div class="col mb-3" style="margin-top: 1rem;">
                        <label for="exampleInputEmail1" class="form-label">Province</label>
                        <input type="text" class="form-control my-input" id="exampleInputEmail1" name="province" aria-describedby="emailHelp" value="<?= $data['user']['province'] ?>" readonly>
                    </div>
                    <div class="col mb-3" style="margin-top:1rem;" >
                        <label for="exampleInputEmail1" class="form-label">City</label>
                        <input type="text" class="form-control my-input" id="exampleInputEmail1" name="city" aria-describedby="emailHelp" value="<?= $data['user']['city'] ?>" readonly>
                    </div>
                    <div class="col mb-3" style="margin-top:1rem;" >
                        <label for="exampleInputEmail1" class="form-label">Postal Code</label>
                        <input type="text" class="form-control my-input" id="exampleInputEmail1" aria-describedby="emailHelp" name="postal_code" value="<?= $data['user']['postal_code'] ?>" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6 mb-3" style="margin-top: 1rem;">
                        <label for="exampleInputEmail1" class="form-label">Country</label>
                        <input type="text" class="form-control my-input" id="exampleInputEmail1" aria-describedby="emailHelp" name="country" value="<?= $data['user']['country'] ?>" readonly>
                    </div>
                    <div class="col-6 mb-3" style="margin-top:1rem;" >
                        <label for="exampleInputEmail1" class="form-label">Phone</label>
                        <input type="text" class="form-control my-input" id="exampleInputEmail1" aria-describedby="emailHelp" name="phone" value="<?= $data['user']['phone'] ?>" readonly>
                    </div>
                </div>
                <div>
